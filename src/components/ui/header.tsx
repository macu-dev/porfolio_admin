...
const Header = ({ logo, links, homeLink = '/' }: HeaderProps) => {
  ...
  return (
    <header
      className={`sticky top-0 z-10 bg-transparent backdrop-blur-sm transition duration-200 ease-in-out ${hasScrolled ? 'border-b border-stone-800' : 'border-transparent'}`}
    >
